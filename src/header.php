...
<html <?php language_attributes(); ?> class="no-js">
  <head>
    ...
    <title><?php wp_title(''); ?><?php if(wp_title('', false)) { echo ' - '; } ?><?php bloginfo('name'); ?><?php if (is_home()) { echo ' - '; } ?><?php if (is_home()) { echo bloginfo('description'); } ?></title>
    ...
    <!-- removed meta description tag in order to use yoast seo / -->
