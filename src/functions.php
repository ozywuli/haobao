...
function twentyfifteen_scripts() {
	...
	wp_enqueue_style( 'twentyfifteen-ie', get_template_directory_uri() . '/assets/css/ie.css', array( 'twentyfifteen-style' ), '20141010' );
	wp_style_add_data( 'twentyfifteen-ie', 'conditional', 'lt IE 9' );

	// Load the Internet Explorer 7 specific stylesheet.
	wp_enqueue_style( 'twentyfifteen-ie7', get_template_directory_uri() . '/assets/css/ie7.css', array( 'twentyfifteen-style' ), '20141010' );
